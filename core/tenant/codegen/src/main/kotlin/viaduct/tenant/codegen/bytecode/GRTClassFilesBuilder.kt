...
internal class GRTClassFilesBuilder(
    ...
    protected override fun isGenerated(def: ViaductSchema.TypeDef): Boolean =
        (args.generatedTypeNamesAllowlist?.contains(def.name) ?: true) &&
            def !is ViaductSchema.Scalar &&
