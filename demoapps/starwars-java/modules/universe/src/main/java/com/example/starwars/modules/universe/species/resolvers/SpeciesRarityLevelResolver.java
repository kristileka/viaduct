...
/** Resolves rarity level from species extras data. */
@Resolver(objectValueFragment = "id")
@Prototype
public final class SpeciesRarityLevelResolver extends SpeciesResolvers.RarityLevel {
  private final SpeciesRepository speciesRepository;

  @Inject
  public SpeciesRarityLevelResolver(SpeciesRepository speciesRepository) {
  ...
  public CompletableFuture<String> resolve(Context context) {
    ...
    return CompletableFuture.completedFuture(
        species == null ? null : species.extrasData().rarityLevel());
  }
}
