...
/** Resolves technological level from species extras data. */
@Resolver(objectValueFragment = "id")
@Prototype
public final class SpeciesTechnologicalLevelResolver extends SpeciesResolvers.TechnologicalLevel {
  private final SpeciesRepository speciesRepository;

  @Inject
  public SpeciesTechnologicalLevelResolver(SpeciesRepository speciesRepository) {
  ...
  public CompletableFuture<String> resolve(Context context) {
    ...
    return CompletableFuture.completedFuture(
        species == null ? null : species.extrasData().technologicalLevel());
  }
}
